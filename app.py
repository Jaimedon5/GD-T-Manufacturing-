...
# ==========================================
# 0. ESTILOS CSS (BLINDADOS Y DE ALTO CONTRASTE)
# ==========================================
st.markdown("""
<style>
...
if mode == "🔬 Análisis Individual":
    ...
    if view == "📐 Simulación 3D":
        ...
        st.markdown(f"""<div class='blueprint-box'><b>Interpretación:</b> La cota controla <b>{info['desc']}</b> dentro de una zona de <b>{info['zone']}</b>.</div>""", unsafe_allow_html=True)
