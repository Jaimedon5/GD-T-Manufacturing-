...
# ==========================================
# 1. BASE DE DATOS COMPLETA (CLAVES CORREGIDAS)
# ==========================================
gdt_data = {
    'Rectitud': {
    ...
    'Alabeo Circular': {'symbol': '↗', 'type': 'runout', 'datum': 'A-B', 'def': 'Variación en una sección al girar.', 'desc': 'Runout Circular', 'zone': 'Distancia radial', 'geo': 'shaft_runout', 'app':'Ejes.', 'why':'Vibración.', 'sim_3d_desc':'Línea de medición en una sección.', 'real_desc':'Giro de pieza en bloques V.'},
    'Alabeo Total': {'symbol': '⌰', 'type': 'runout', 'datum': 'A-B', 'def': 'Variación de toda la superficie al girar.', 'desc': 'Runout Total', 'zone': 'Distancia radial total', 'geo': 'shaft_runout', 'app':'Rodillos.', 'why':'Balanceo.', 'sim_3d_desc':'Malla completa de la superficie.', 'real_desc':'Giro y desplazamiento longitudinal.'},
    'Perfil de una línea': {'symbol': '⌒', 'type': 'profile', 'datum': False, 'def': 'Forma de una curva 2D.', 'desc': 'Perfil de línea', 'zone': 'Banda uniforme', 'geo': 'curved_surf', 'app':'Alas.', 'why':'Aerodinámica.', 'sim_3d_desc':'Curva 2D entre límites.', 'real_desc':'Proyector de perfiles.'},
    'Perfil de una superficie': {'symbol': '⌓', 'type': 'profile', 'datum': False, 'def': 'Forma de superficie 3D.', 'desc': 'Perfil de superficie', 'zone': 'Banda 3D', 'geo': 'curved_surf', 'app':'Carrocería.', 'why':'Estética.', 'sim_3d_desc':'Superficie 3D entre límites.', 'real_desc':'Escaneo CMM.'},
    'Concentricidad': {'symbol': '◎', 'type': 'loc', 'datum': 'A', 'def': 'Coaxialidad de puntos medios.', 'desc': 'Concentricidad', 'zone': 'Cilindro coaxial', 'geo': 'concentric', 'app':'Rotores.', 'why':'Balanceo.', 'sim_3d_desc':'Puntos medios alineados.', 'real_desc':'Medición diferencial.'}
}
...
def draw_blueprint(feature, tol_val):
    ...
    if datum:
        ...
        if ftype == 'surf': fig.add_annotation(x=6, y=2, text="<b>A</b>", showarrow=True, arrowhead=2, ay=20)
        else: fig.add_annotation(x=2, y=5, text="<b>A</b>", showarrow=True, arrowhead=2, ay=0, ax=-20)
